...
interface ERC721RaribleMetaInterface extends ethers.utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MINTER_ROLE()": FunctionFragment;
    "PAUSER_ROLE()": FunctionFragment;
    "POLYNETWORK_ROLE()": FunctionFragment;
    "__ERC721RaribleMeta_init(string,string,string)": FunctionFragment;
    "__ERC721RaribleUserMeta_init(string,string,string,address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__ERC721RaribleMeta_init",
    values: [string, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "__ERC721RaribleUserMeta_init",
  ...
  events: {
    ...
    "CreateERC721RaribleMeta(address,string,string)": EventFragment;
    "CreateERC721RaribleUserMeta(address,string,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CreateERC721RaribleMeta"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "CreateERC721RaribleUserMeta"
  ): EventFragment;
...
export type CreateERC721RaribleMetaEvent = TypedEvent<
  [string, string, string] & { owner: string; name: string; symbol: string }
>;

export type CreateERC721RaribleUserMetaEvent = TypedEvent<
  [string, string, string] & { owner: string; name: string; symbol: string }
>;
...
export class ERC721RaribleMeta extends BaseContract {
  ...
  filters: {
    ...
    "CreateERC721RaribleMeta(address,string,string)"(
      owner?: null,
      name?: null,
      symbol?: null
    ): TypedEventFilter<
      [string, string, string],
      { owner: string; name: string; symbol: string }
    >;

    CreateERC721RaribleMeta(
      owner?: null,
      name?: null,
      symbol?: null
    ): TypedEventFilter<
    ...
    "CreateERC721RaribleUserMeta(address,string,string)"(
      owner?: null,
      name?: null,
      symbol?: null
    ): TypedEventFilter<

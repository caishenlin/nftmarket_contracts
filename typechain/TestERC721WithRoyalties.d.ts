...
interface TestERC721WithRoyaltiesInterface extends ethers.utils.Interface {
  functions: {
...
export class TestERC721WithRoyalties extends BaseContract {
  ...
  interface: TestERC721WithRoyaltiesInterface;

...
interface TestERC1155WithRoyaltiesInterface extends ethers.utils.Interface {
  functions: {
...
export class TestERC1155WithRoyalties extends BaseContract {
  ...
  interface: TestERC1155WithRoyaltiesInterface;

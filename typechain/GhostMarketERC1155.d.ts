...
interface GhostMarketERC1155Interface extends ethers.utils.Interface {
  functions: {
...
export class GhostMarketERC1155 extends BaseContract {
  ...
  interface: GhostMarketERC1155Interface;

...
interface GhostMarketTransferManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class GhostMarketTransferManager extends BaseContract {
  ...
  interface: GhostMarketTransferManagerInterface;

...
interface GhostMarketRoyaltiesInterface extends ethers.utils.Interface {
  functions: {
...
export class GhostMarketRoyalties extends BaseContract {
  ...
  interface: GhostMarketRoyaltiesInterface;

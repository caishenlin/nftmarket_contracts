...
interface LibExchangeAuctionInterface extends ethers.utils.Interface {
  functions: {
    ...
    values: [
      {
        ...
        auctionSpecAddr: [string, string, string];
...
export class LibExchangeAuction extends BaseContract {
  ...
  interface: LibExchangeAuctionInterface;

...
interface TestExchangeV2Interface extends ethers.utils.Interface {
  functions: {
    "__ExchangeV2_init(address,address,uint256,address)": FunctionFragment;
    ...
    "matchAndTransferExternal(tuple,tuple)": FunctionFragment;
    "matchOrders(tuple,bytes,tuple,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "matchAndTransferExternal",
    values: [
      {
        maker: string;
        makeAsset: {
  ...
  events: {
    ...
    "OrderFilled(bytes32,bytes32,address,address,uint256,uint256)": EventFragment;
...
export class TestExchangeV2 extends BaseContract {
  ...
  interface: TestExchangeV2Interface;
  ...
  filters: {
    ...
    "OrderFilled(bytes32,bytes32,address,address,uint256,uint256)"(
      leftHash?: null,
      rightHash?: null,
      leftMaker?: null,
      rightMaker?: null,

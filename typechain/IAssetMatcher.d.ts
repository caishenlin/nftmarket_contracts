...
interface IAssetMatcherInterface extends ethers.utils.Interface {
  functions: {
    "matchAssets(tuple,tuple)": FunctionFragment;
  };
...
export class IAssetMatcher extends BaseContract {

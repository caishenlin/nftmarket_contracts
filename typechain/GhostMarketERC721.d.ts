...
interface GhostMarketERC721Interface extends ethers.utils.Interface {
  functions: {
...
export class GhostMarketERC721 extends BaseContract {
  ...
  interface: GhostMarketERC721Interface;

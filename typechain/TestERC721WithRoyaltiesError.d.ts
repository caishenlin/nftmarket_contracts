...
interface TestERC721WithRoyaltiesErrorInterface extends ethers.utils.Interface {
  functions: {
...
export class TestERC721WithRoyaltiesError extends BaseContract {
  ...
  interface: TestERC721WithRoyaltiesErrorInterface;
